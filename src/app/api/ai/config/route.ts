...
/** GET /api/ai/config — safe account-scoped AI configuration. */
...
/** POST /api/ai/config (admin+) — validate then persist encrypted BYO key. */
...
/** DELETE /api/ai/config (admin+) — remove config and encrypted key. */
