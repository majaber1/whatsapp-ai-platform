...
/**
 * Groq exposes an OpenAI-compatible chat-completions API, but we keep a
 * dedicated adapter so provider policy, telemetry and future Groq-specific
 * options do not leak into the OpenAI implementation.
 */
